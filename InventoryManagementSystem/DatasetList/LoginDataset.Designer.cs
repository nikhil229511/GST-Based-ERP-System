...
namespace InventoryManagementSystem.DatasetList.LoginDatasetTableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        public virtual int Fill(LoginDataset.LoginDataTable dataTable, string USERNAME, string PASSWORD) {
        ...
        public virtual LoginDataset.LoginDataTable GetData(string USERNAME, string PASSWORD) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((USERNAME == null)) {
                this.Adapter.SelectCommand.Parameters[1].Value = global::System.DBNull.Value;
            }
